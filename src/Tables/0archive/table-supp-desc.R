...
levels(all$beach)=c("Avalon","Doheny","Fairhope","Goddard",
                    "Malibu","Mission Bay")
...
# head.beach=table(all$headunder,all$beach)[2,]
# head.beach.p=prop.table(table(all$headunder,all$beach),2)[2,]
# 
...
p.print=rbind(age.beach.p,fem.beach.p,white.beach.p,any.beach.p,body.beach.p)

# n.print=rbind(age.beach,fem.beach,white.beach,any.beach,body.beach,
#               head.beach,swall.beach)
# p.print=rbind(age.beach.p,fem.beach.p,white.beach.p,any.beach.p,body.beach.p,
#               head.beach.p,swall.beach.p)
...
table.print$label=c("Individuals","Households","0-4","5-14","15-24","25-34","35-44",
      ...
      "White","Total","Any contact")
# table.print$label=c("Individuals","Households","0-4","5-14","15-24","25-34","35-44",
#       "45-54","55-64","65-74","75+","Total","Male","Female","Total","Not white",
#       "White","Total","Any contact","Body contact","Head under","Swallowed water")
for(i in 3:22){
...
save(table.print,file="~/Dropbox/Coliphage/Data/Temp/desctab.RData")
