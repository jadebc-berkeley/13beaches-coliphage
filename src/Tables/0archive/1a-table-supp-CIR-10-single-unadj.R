...
load("results/rawoutput/regress-10day-body-unadj.Rdata")
load("results/rawoutput/regress-10day-body-entero-unadj.Rdata")
...
save(gici10.tab.out,file="~/Documents/CRG/coliphage/Results/Tables/CIR-pool-10.RData")
