...
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-body-joint-unadj.Rdata")
...
save(gici10.joint.tab.all,file="~/Documents/CRG/coliphage/Results/Tables/CIR-joint-10.RData")
