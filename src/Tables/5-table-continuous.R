...
coli.n=c(all.n10.fmc1601,all.n10.fmc1602.high,all.n10.fmc1602.low,all.n10.fpc1601.high,
all.n10.fpc1601.low,all.n10.fpc1602.high,all.n10.fpc1602.low)

ent.n=c(all.n10.ent.fmc1601,
...
# entero
ent.fmc1601=CIRformat(getCIR(overall.fit10.entero.fmc1601))
...
# coliphage
fmc1601=CIRformat(getCIR(overall.fit10.fmc1601))
...
# make table rows
fmc1601.row=c(fmc1601,ent.fmc1601)
...
# make table
table=data.frame(rbind(fmc1601.row,fmc1602.row.low,fmc1602.row.high,
                       fpc1601.row.low,fpc1601.row.high,
                       fpc1602.row.low,fpc1602.row.high))

lab1=c("EPA Method 1601","EPA Method 1602","EPA Method 1602",
