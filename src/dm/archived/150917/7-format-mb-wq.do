...
insheet using "~/dropbox/13beaches/data/untouched/missionbay/wq/tblMicrobiologyData.csv", comma clear
...
insheet using "~/dropbox/13beaches/data/untouched/missionbay/wq/PCR Data All.csv", comma clear
...
insheet using "~/dropbox/13beaches/data/untouched/missionbay/wq/tblPhageData.csv", comma clear
...
order sampletype beachcode stationid coldate coltime enteroELTmpn - tcolifcfu_nd enteroQPCRcce - bactQPCRcce_nd 
