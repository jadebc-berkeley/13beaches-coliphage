...
* major re-write of the script to process
* individual water sample data and 
* output a dataset with a row for each sample
*
...
insheet using "~/dropbox/13beaches/data/untouched/neear/wqentero1600marine.txt", clear
...
insheet using "~/dropbox/13beaches/data/untouched/neear/wqentero16002009.txt", clear
...
insheet using "~/dropbox/13beaches/data/untouched/neear/wqepcrddctfresh.txt", clear
tempfile freshqpcr
save `freshqpcr'
insheet using "~/dropbox/13beaches/data/untouched/neear/wqepcrddctmarine.txt", clear
tempfile marineqpcr
save `marineqpcr'
insheet using "~/dropbox/13beaches/data/untouched/neear/wqepcrddct2009.txt", clear
...
outsheet using "~/dropbox/13beaches/data/final/neear-wq-samples.csv", comma replace
...
*----------------------------------------
* output a daily average dataset
*----------------------------------------
note: samples below detection were imputed with 0.1 before calculating log10 averages
compress
label data "NEEAR daily average water quality data, created by 5-format-neear-wq.do"
save "~/dropbox/13beaches/data/final/neear-wq.dta", replace
outsheet using "~/dropbox/13beaches/data/final/neear-wq.csv", comma replace
