...
log using "~/Documents/CRG/coliphage/13beaches-coliphage/src/dm/2-format-adm-epi.log", text replace
...
* write a codebook
log using "~/Documents/CRG/coliphage/13beaches-data/final/adm-epi-codebook.txt", text replace
desc, s
*aorder
codebook
log close
