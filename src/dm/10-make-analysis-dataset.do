...
log using "~/dropbox/13beaches-fork-coliphage/src/dm/10-make-analysis-dataset.log", text replace
...
use "~/dropbox/13beaches-fork-coliphage/data/final/13beaches-epi.dta", clear
...
use "~/dropbox/13beaches-fork-coliphage/data/final/13beaches-wq.dta", clear
...
saveold "~/dropbox/13beaches-fork-coliphage/data/final/13beaches-analysis.dta", replace version(12)
outsheet using "~/dropbox/13beaches-fork-coliphage/data/final/13beaches-analysis.csv", comma replace
...
log close
log using "~/dropbox/13beaches-fork-coliphage/data/final/13beaches-analysis-codebook.txt", text replace
desc, s
notes
codebook
log close
