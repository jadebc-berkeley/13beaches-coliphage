...
# Huntington
hufit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Huntington")

# Silver
sifit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Silver")

# Washington Park
wpfit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Washington Park")

# West
wefit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="West")
...
# Avalon
avfit <- lbreg(gici10~avgdyenterocfu*groundwater,dat=d,beach="Avalon",vcv=TRUE)

# Boqueron
bofit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Boqueron")

# Doheny
dhfit <- lbreg(gici10~avgdyenterocfu*berm,dat=d,beach="Doheny",vcv=TRUE)

# Edgewater
edfit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Edgewater")

# Fairhope
fafit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Fairhope")

# Goddard
gdfit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Goddard")

# Malibu
mafit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Malibu")

# Surfside
sufit <- lbreg(gici10~avgdyenterocfu,dat=d,beach="Surfside")
...
# Huntington
hucfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Huntington")

# Silver
sicfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Silver")

# Washington Park
wpcfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Washington Park")

# West
wecfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="West")
...
# Avalon
avcfit <- lbreg(gici10~avgdyenterocfu*groundwater,dat=dch,beach="Avalon",vcv=TRUE)

# Boqueron
bocfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Boqueron")

# Doheny
dhcfit <- lbreg(gici10~avgdyenterocfu*berm,dat=dch,beach="Doheny",vcv=TRUE)

# Edgewater
edcfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Edgewater")

# Fairhope
facfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Fairhope")

# Goddard
gdcfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Goddard")

# Malibu
macfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Malibu")

# Surfside
sucfit <- lbreg(gici10~avgdyenterocfu,dat=dch,beach="Surfside")
...
pdf("~/dropbox/13beaches/aim1-results/figs/cirplot-epa1600-all.pdf",width=6,height=8)
...
ylims <- c(0.1,8)
pdf("~/dropbox/13beaches/aim1-results/figs/cirplot-epa1600-child.pdf",width=6,height=8)
