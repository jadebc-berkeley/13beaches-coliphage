...
# streamlined code to simplify scenarios
#
...
# # --------------------------------------
# # NEED TO UPDATE THE CODE BELOW TO
# # ACCOMMODATE NEW OUTPUT BEFORE MAKING
# # FOREST PLOTS
# # --------------------------------------
...
# load("~/dropbox/13beaches/aim1-results/rawoutput/aim1-swim-exposure-regs.Rdata")
