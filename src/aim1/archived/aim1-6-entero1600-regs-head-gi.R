...
av.h.noint <-glm(gici3~ qentero1600+groundwater +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,family=poisson(link="log"),data=ah[ah$beach=="Avalon",])
av.h <-glm(gici3~ qentero1600*groundwater +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,family=poisson(link="log"),data=ah[ah$beach=="Avalon",])
	lrtest(av.h.noint,av.h)

dh.h.noint <-glm(gici3~qentero1600+berm +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,family=poisson(link="log"),data=ah[ah$beach=="Doheny",])
dh.h <-glm(gici3~ qentero1600*berm +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,family=poisson(link="log"),data=ah[ah$beach=="Doheny",])
...
# Huntington
hufit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Huntington",vcv=TRUE)

# Silver
sifit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Silver",vcv=TRUE)

# Washington Park
wpfit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Washington Park",vcv=TRUE)

# West
wefit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="West",vcv=TRUE)

# --------------------------------------
# Marine beaches

# Avalon
avfit <- mpreg(gici3~qentero1600*groundwater +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Avalon",vcv=TRUE)

# Boqueron
bofit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Boqueron",vcv=TRUE)

# Doheny
dhfit <- mpreg(gici3~qentero1600*berm +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Doheny",vcv=TRUE)

# Edgewater
edfit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Edgewater",vcv=TRUE)

# Fairhope
fafit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Fairhope",vcv=TRUE)

# Goddard
gdfit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Goddard",vcv=TRUE)

# Malibu
mafit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Malibu",vcv=TRUE)

# Mission Bay
mbfit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Mission Bay",vcv=TRUE)

# Surfside
sufit <- mpreg(gici3~qentero1600 +agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood,dat=ah,beach="Surfside",vcv=TRUE)
...
# all beaches
all.fit <- glm(gici3~qentero1600 +marine+pointsource+agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood+beach,family=poisson(link="log"),data=ah)
	all.VC <- cl(ah,fm=all.fit,cluster=ah$hhid)
	all.head <- coeftest(all.fit, all.VC) 

# Interaction model with fresh v. marine beaches
mf.fit <- glm(gici3~qentero1600*marine +pointsource+agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood+beach,family=poisson(link="log"),data=ah)
...
ps.fit <- glm(gici3~qentero1600*pointsource +marine+agecat+female+racewhite+gichron+anim_any+gicontactbase+rawfood+beach,family=poisson(link="log"),data=ah)
	# commented out robust SE calcs b/c not used (no interaction)
...
noage.fit <- glm(gici3~qentero1600 +agestrat+marine+pointsource+female+racewhite+gichron+anim_any+gicontactbase+rawfood+beach,family=poisson(link="log"),data=aha)

# Pooled estimate (Age 0-4, 5-10, >10), Head Immersion
agestrat.fit <- glm(gici3~ qentero1600*agestrat +marine+pointsource+female+racewhite+gichron+anim_any+gicontactbase+rawfood+beach,family=poisson(link="log"),data=aha)
...
ageps.fit <- glm(gici3~ (qentero1600*agestrat*pointsource) +marine+female+racewhite+gichron+anim_any+gicontactbase+rawfood+beach,family=poisson(link="log"),data=aha)
...
# category
# --------------------------------------
ci.all <- tapply(ah$gici3,ah$qentero1600,mean)*1000
ci.age0to4 <- tapply(ah$gici3[ah$agestrat=="(0, 4]"],ah$qentero1600[ah$agestrat=="(0, 4]"],mean)*1000
ci.age5to10 <- tapply(ah$gici3[ah$agestrat=="(4, 10]"],ah$qentero1600[ah$agestrat=="(4, 10]"],mean)*1000
ci.age11plus <- tapply(ah$gici3[ah$agestrat==">10"],ah$qentero1600[ah$agestrat==">10"],mean)*1000
...
# save the objects
# --------------------------------------
save.image("~/dropbox/13beaches/aim1-results/rawoutput/aim1-entero1600-regs-head.Rdata")
