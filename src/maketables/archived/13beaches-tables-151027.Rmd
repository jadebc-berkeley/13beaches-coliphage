...
\begin{enumerate}
  ...
  \item Population Attributable Risk is the number of events per 1000 beachgoers that would be prevented if swimming exposure were removed from the population. The proportion exposed to body immersion swimming was: all ages (`r pctexp[1]`), ages 0-4 (`r pctexp[2]`), ages 5-10 (`r pctexp[3]`), ages >10 (`r pctexp[4]`). Table 1 includes additional details.
