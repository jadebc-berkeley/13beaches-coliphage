...
load("~/dropbox/coliphage/results/rawoutput/regress-10day-body-negcontrol.Rdata")
load("~/dropbox/coliphage/results/rawoutput/regress-10day-body-entero-negcontrol.Rdata")
load("~/dropbox/coliphage/results/rawoutput/regress-10day-body-joint-negcontrol.Rdata")  
...
pdf("~/dropbox/coliphage/results/figures/forestplots_new_negcontrol.pdf",height=5,width=14)
