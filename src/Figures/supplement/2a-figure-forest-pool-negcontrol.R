...
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-body-pool-negcontrol.Rdata")
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-body-entero-pool-negcontrol.Rdata")
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-body-joint-pool-negcontrol.Rdata")  
...
pdf("~/Documents/CRG/coliphage/results/figures/forestplots_pool_negcontrol.pdf",height=5,width=9)
ggplot(gici10.plot,aes(x=lab.f,y=pt.est))+
  ...
  scale_y_log10(breaks=c(0.2,0.5,1,2),limits=c(0.2,3))+theme_complete_bw()+
