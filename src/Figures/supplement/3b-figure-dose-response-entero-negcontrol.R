...
# Enterococcus, negative control analysis
...
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-continuous-CIR-body-entero-negcontrol.Rdata")
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-entero-fmc1601-all-negcontrol.pdf",height=7,width=5)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-entero-fmc1601-negcontrol.pdf",height=6,width=7)
plotPy.em(all.fmc1601.pY.low,all.fmc1601.pY.high,
          ...
          CIRres1=CIRformat(getCIR(overall.fit10.entero.low.fmc1601)),
          CIRres0=CIRformat(getCIR(overall.fit10.entero.high.fmc1601)),
          Exp1=all$entero[all$risk=="Low" & all$entero>-1 & !is.na(all$fmc1601)],
          Exp0=all$entero[all$risk=="High" & all$entero>-1 & !is.na(all$fmc1601)],
          lab1="Low risk conditions",lab0="High risk conditions"
)
dev.off()


pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-entero-fmc1602-all-negcontrol.pdf",height=7,width=5)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-entero-fmc1602-negcontrol.pdf",height=6,width=7)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-entero-fpc1601-all-negcontrol.pdf",height=7,width=5)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-entero-fpc1601-negcontrol.pdf",height=6,width=7)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-entero-fpc1602-all-negcontrol.pdf",height=7,width=5)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-entero-fpc1602-negcontrol.pdf",height=6,width=7)
