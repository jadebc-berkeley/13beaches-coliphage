...
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-continuous-CIR-body-negcontrol.Rdata")

# --------------------------------------
# make figures
# --------------------------------------

pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-fmc1601-all-negcontrol.pdf",height=7,width=5)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-fmc1601-negcontrol.pdf",height=6,width=7)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-fmc1602-all-negcontrol.pdf",height=7,width=5)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-fmc1602-negcontrol.pdf",height=6,width=7)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-fpc1601-all-negcontrol.pdf",height=7,width=5)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-fpc1602-all-negcontrol.pdf",height=7,width=5)
...
pdf("~/Documents/CRG/coliphage/results/figures/dose-response-pool-fpc1602-negcontrol.pdf",height=6,width=7)
