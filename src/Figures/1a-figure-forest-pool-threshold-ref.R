...
load("~/dropbox/coliphage/results/rawoutput/regress-10day-body-pool-threshold-ref.Rdata")
...
pdf("~/dropbox/coliphage/results/figures/forestplots_pool_threshold_ref.pdf",height=5,width=9)
