...
load("~/dropbox/coliphage/results/rawoutput/regress-10day-body-pool-negcontrol.Rdata")
load("~/dropbox/coliphage/results/rawoutput/regress-10day-body-entero-pool-negcontrol.Rdata")
load("~/dropbox/coliphage/results/rawoutput/regress-10day-body-joint-pool-negcontrol.Rdata")  
...
pdf("~/dropbox/coliphage/results/figures/forestplots_pool_negcontrol.pdf",height=5,width=9)
