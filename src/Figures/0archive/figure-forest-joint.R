...
gici10.plot$type=as.factor(c(rep("Coliphage & Enterococcus",10),rep("Enterococcus Only",10)))
...
#pdf("~/dropbox/coliphage/results/figures/forestplot-joint.pdf",height=4,width=16)
