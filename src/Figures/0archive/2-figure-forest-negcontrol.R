...
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-body-negcontrol.Rdata")
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-body-entero-negcontrol.Rdata")
load("~/Documents/CRG/coliphage/results/rawoutput/regress-10day-body-joint-negcontrol.Rdata")  
...
gici10.body.pool=list(nc.overall.fit10.fmc1601, nc.overall.fit10.fmc1602,
                      nc.overall.fit10.fpc1601, nc.overall.fit10.fpc1602)

gici10.body.high=list(nc.overall.fit10.fmc1602.high,
                      nc.overall.fit10.fpc1601.high, nc.overall.fit10.fpc1602.high)

gici10.body.low=list(nc.overall.fit10.fmc1602.low,
                     nc.overall.fit10.fpc1601.low, nc.overall.fit10.fpc1602.low)

# entero results
gici10.entero.pool=list(nc.overall.fit10.entero.fmc1601,nc.overall.fit10.entero.fmc1602,
                        nc.overall.fit10.entero.fpc1601,nc.overall.fit10.entero.fpc1602)
gici10.entero.high=list(nc.overall.fit10.entero.high.fmc1602,nc.overall.fit10.entero.high.fpc1601,
                        nc.overall.fit10.entero.high.fpc1602)
gici10.entero.low=list(nc.overall.fit10.entero.low.fmc1602,nc.overall.fit10.entero.low.fpc1601,
                       nc.overall.fit10.entero.low.fpc1602)

# joint results
gici10.body.int=list(nc.overall.fit10.fmc1601.int, nc.overall.fit10.fmc1602.int,
                     nc.overall.fit10.fpc1601.int, nc.overall.fit10.fpc1602.int)

gici10.body.high.int=list(nc.overall.fit10.fmc1602.high.int,
                          nc.overall.fit10.fpc1601.high.int, nc.overall.fit10.fpc1602.high.int)

gici10.body.low.int=list(nc.overall.fit10.fmc1602.low.int,
                         nc.overall.fit10.fpc1601.low.int, nc.overall.fit10.fpc1602.low.int)
...
pdf("~/Documents/CRG/coliphage/results/figures/forestplots_new_negcontrol.pdf",height=5,width=14)
ggplot(gici10.plot,aes(x=lab.f,y=pt.est))+
  ...
  scale_y_log10(breaks=c(0.1,0.2,0.5,1,2,5),limits=c(0.1,5))+theme_complete_bw()+
