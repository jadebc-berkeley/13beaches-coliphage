# --------------------------------------
# 4-aim1-entero1600-summary-figures.R
...
#	aim1-entero1600-35cfu-CI-byage-pointsource.pdf
#	aim1-entero1600-35cfu-CI-byage-nonpointsource.pdf
# --------------------------------------
...
mtext(expression(paste(italic("Enterococcus")," 1600")),side=3,line=4,at=labx,adj=1,col=cols[2],cex=0.8)
