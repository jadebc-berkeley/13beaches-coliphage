...
# --------------------------------------
# 7-aim2-PAR-entero1600-workgi.R
...
AR35cfu.workgi <- bootAR(fn="AR35cfu",fmla=fmla,data=ad,ID=ad$hhid,strata=ad$beach,iter=1000)

# save results down
rm(ad)
save.image(file="~/dropbox/13beaches/aim2-results/rawoutput/aim2-PARentero1600-workgi.RData")
