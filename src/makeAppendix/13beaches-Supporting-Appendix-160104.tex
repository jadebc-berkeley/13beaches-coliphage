...
% \begin{center}
% \begin{minipage}{\textwidth}
% \caption{Population Attributable Risk Among Body Immersion Swimmers Due to Swimming in Water That Exceeds the EPA Guideline of \textit{Enterococcus} >35 CFU/100ml.  Missed paid work and medical visits due to gastrointestinal illness were too rare to calculate stratified estimates (results in eTable \ref{tab:ARwatexp}).   \label{tab:parpointsource}}
% \end{minipage}
% \begin{tabular}{l rr cc rl rl}
%  & \\
%  &  &  & \multicolumn{2}{c}{Predicted Incidence$^1$}  & \multicolumn{2}{c}{Population}        & \multicolumn{2}{c}{Population}    \\
