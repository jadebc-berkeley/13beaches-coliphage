...
file="~/Documents/CRG/coliphage/results/rawoutput/regress-10day-continuous-body-entero-n-negcontrol.Rdata")
...
save(
  ...
  all.VC10.entero.low.fpc1602,
    ...
    file="~/Documents/CRG/coliphage/results/rawoutput/regress-10day-continuous-CIR-body-entero-negcontrol.Rdata"
)
