...
# load base functions
source("~/Documents/CRG/coliphage/13beaches-coliphage/src/Programs/Analysis/0-base-functions.R")
...
save(
  ...
  file="~/Documents/CRG/coliphage/results/rawoutput/regress-10day-body-joint-negcontrol.Rdata"
)
