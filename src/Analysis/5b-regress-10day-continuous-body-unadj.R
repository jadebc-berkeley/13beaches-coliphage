...
#-------------------------------------------
# fmc 1601 ---------------------------------
all.fit10.fmc1601 <- glm(gici10~fmc1601,family=poisson(link="log"),data=all[!is.na(all$fmc1601),])
...
# fmc 1602 ---------------------------------
all.fit10.fmc1602 <- glm(gici10~fmc1602,family=poisson(link="log"),data=all[!is.na(all$fmc1602),])
...
all.fit10.fmc1602.high <- glm(gici10~fmc1602,family=poisson(link="log"),data=data.high)
...
all.fit10.fmc1602.low <- glm(gici10~fmc1602,family=poisson(link="log"),data=data.low)
...
# fpc 1601 ---------------------------------
all.fit10.fpc1601 <- glm(gici10~fpc1601,family=poisson(link="log"),data=all[!is.na(all$fpc1601) ,])
...
data.high=subset(data,data$risk=="High")
all.fit10.fpc1601.high <- glm(gici10~fpc1601,family=poisson(link="log"),data=data.high)
...
# low risk conditions
data.low=subset(data,data$risk=="Low")
all.fit10.fpc1601.low <- glm(gici10~fpc1601,family=poisson(link="log"),data=data.low)
...
# fpc 1602 ---------------------------------
all.fit10.fpc1602 <- glm(gici10~fpc1602,family=poisson(link="log"),data=all[!is.na(all$fpc1602) ,])
...
data.high=subset(data,data$risk=="High")
all.fit10.fpc1602.high <- glm(gici10~fpc1602,family=poisson(link="log"),data=data.high)
...
# low risk conditions
data.low=subset(data,data$risk=="Low")
all.fit10.fpc1602.low <- glm(gici10~fpc1602,family=poisson(link="log"),data=data.low)
...
# fmc 1601 ---------------------------------
all.fmc1601.pY = boot.pY(fmla=gici10~fmc1601,dat=all[!is.na(all$fmc1601),],nameX="fmc1601",
    ID=all[!is.na(all$fmc1601),"hhid"],iter)

# fmc 1602 ---------------------------------
all.fmc1602.pY = boot.pY(fmla=gici10~fmc1602,dat=all[!is.na(all$fmc1602),],nameX="fmc1602",
    ID=all[!is.na(all$fmc1602),"hhid"],iter)
data=all[!is.na(all$fmc1602) ,]
data.high=subset(data,data$risk=="High")
all.fmc1602.pY.high = boot.pY(fmla=gici10~fmc1602,dat=data.high,nameX="fmc1602",ID=data.high$hhid,iter)
data.low=subset(data,data$risk=="Low")
all.fmc1602.pY.low = boot.pY(fmla=gici10~fmc1602,dat=data.low,nameX="fmc1602",ID=data.low$hhid,iter)

# fpc 1601 ---------------------------------
all.fpc1601.pY = boot.pY(fmla=gici10~fpc1601,dat=all[!is.na(all$fpc1601),],nameX="fpc1601",
    ID=all[!is.na(all$fpc1601),"hhid"],iter)
data=all[!is.na(all$fpc1601) ,]
data.high=subset(data,data$risk=="High")
all.fpc1601.pY.high = boot.pY(fmla=gici10~fpc1601,dat=data.high,nameX="fpc1601",ID=data.high$hhid,iter)
data.low=subset(data,data$risk=="Low")
all.fpc1601.pY.low = boot.pY(fmla=gici10~fpc1601,dat=data.low,nameX="fpc1601",ID=data.low$hhid,iter)

# fpc 1602 ---------------------------------
all.fpc1602.pY = boot.pY(fmla=gici10~fpc1602,dat=all[!is.na(all$fpc1602),],nameX="fpc1602",
    ID=all[!is.na(all$fpc1602),"hhid"],iter)
data=all[!is.na(all$fpc1602) ,]
data.high=subset(data,data$risk=="High")
all.fpc1602.pY.high = boot.pY(fmla=gici10~fpc1602,dat=data.high,nameX="fpc1602",ID=data.high$hhid,iter)
data.low=subset(data,data$risk=="Low")
all.fpc1602.pY.low = boot.pY(fmla=gici10~fpc1602,dat=data.low,nameX="fpc1602",ID=data.low$hhid,iter)
...
save(
  ...
  file="~/Documents/CRG/coliphage/results/rawoutput/regress-10day-continuous-body-unadj.Rdata"
