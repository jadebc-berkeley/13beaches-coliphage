...
avfit10.fmc1602 = mpreg(gici10~fmc1602.pres,
    dat=avalon,vcv=T)
avfit10.fpc1601 = mpreg(gici10~fpc1601.pres,
    dat=avalon,vcv=T)
avfit10.fpc1602 = mpreg(gici10~fpc1602.pres,
    dat=avalon,vcv=T)

# doheny
dofit10.fmc1601 = mpreg(gici10~fmc1601.pres,
     dat=doheny[!is.na(doheny$fmc1601.pres),],vcv=T)
dofit10.fmc1602 = mpreg(gici10~fmc1602.pres,
    dat=doheny,vcv=T)
dofit10.fpc1601 = mpreg(gici10~fpc1601.pres,
    dat=doheny,vcv=T)
dofit10.fpc1602 = mpreg(gici10~fpc1602.pres,
    dat=doheny,vcv=T)

# fairhope
fafit10.fpc1601 = mpreg(gici10~fpc1601.pres,
...
# malibu
# fmc 1602 and fpc 1602 always present at malibu
mafit10.fpc1601 = mpreg(gici10~fpc1601.pres,
    dat=malibu[!is.na(malibu$fpc1601.pres),],vcv=T)

# mission bay
mbfit10.fmc1601 = mpreg(gici10~fmc1601.pres,
    dat=mission[!is.na(mission$fmc1601.pres),],vcv=T)
mbfit10.fpc1601 = mpreg(gici10~fpc1601.pres,
...
avfit10.fmc1602.glm = glm(gici10~fmc1602.pres+groundwater,
    dat=avalon,family=poisson(link="log"))
# interaction model
avfit10.fmc1602.gw = glm(gici10~fmc1602.pres*groundwater,
    family=poisson(link="log"),data=avalon)
summary(avfit10.fmc1602.gw)
lrtest(avfit10.fmc1602.glm,avfit10.fmc1602.gw)

# reduced model for LR test
avfit10.fpc1601.glm = glm(gici10~fpc1601.pres+groundwater,
    dat=avalon,family=poisson(link="log"))
# interaction model
avfit10.fpc1601.gw = glm(gici10~fpc1601.pres*groundwater,
    dat=avalon,family=poisson(link="log"))
summary(avfit10.fpc1601.gw)
lrtest(avfit10.fpc1601.glm,avfit10.fpc1601.gw)

# reduced model for LR test
avfit10.fpc1602.glm = glm(gici10~fpc1602.pres+groundwater,
    dat=avalon,family=poisson(link="log"))
# interaction model
avfit10.fpc1602.gw = glm(gici10~fpc1602.pres*groundwater,
    dat=avalon,family=poisson(link="log"))
...
# reduced model for LR test
dofit10.fmc1602.glm = glm(gici10~fmc1602.pres+berm,
    dat=doheny,family=poisson(link="log"))
# interaction model
dofit10.fmc1602.berm = glm(gici10~fmc1602.pres*berm,
    dat=doheny,family=poisson(link="log"))
summary(dofit10.fmc1602.berm)
lrtest(dofit10.fmc1602.glm,dofit10.fmc1602.berm)

# reduced model for LR test
dofit10.fpc1601.glm = glm(gici10~fpc1601.pres+berm,
    dat=doheny,family=poisson(link="log"))
# interaction model
dofit10.fpc1601.berm = glm(gici10~fpc1601.pres*berm,
    dat=doheny,family=poisson(link="log"))
summary(dofit10.fpc1601.berm)
lrtest(dofit10.fpc1601.glm,dofit10.fpc1601.berm)

# reduced model for LR test
dofit10.fpc1602.glm = glm(gici10~fpc1602.pres+berm,
    dat=doheny,family=poisson(link="log"))
# interaction model
dofit10.fpc1602.berm = glm(gici10~fpc1602.pres*berm,
    dat=doheny,family=poisson(link="log"))
summary(dofit10.fpc1602.berm)
lrtest(dofit10.fpc1602.glm,dofit10.fpc1602.berm)

# reduced model for LR test
mafit10.fpc1601.glm = glm(gici10~fpc1601.pres,
    dat=malibu[!is.na(malibu$fpc1601.pres),],family=poisson(link="log"))
# interaction model
mafit10.fpc1601.berm = glm(gici10~fpc1601.pres*berm,
    dat=malibu[!is.na(malibu$fpc1601.pres),],family=poisson(link="log"))
...
#-----------------------------------------
avfit10.fmc1602.gw.1 = mpreg(gici10~fmc1602.pres,
    vcv=T,dat=avalon[avalon$groundwater=="Above median flow",])
avfit10.fmc1602.gw.0 = mpreg(gici10~fmc1602.pres,
    vcv=T,dat=avalon[avalon$groundwater=="Below median flow",])

avfit10.fpc1601.gw.1 = mpreg(gici10~fpc1601.pres,
    vcv=T,dat=avalon[avalon$groundwater=="Above median flow",])
avfit10.fpc1601.gw.0 = mpreg(gici10~fpc1601.pres,
    vcv=T,dat=avalon[avalon$groundwater=="Below median flow",])

avfit10.fpc1602.gw.1 = mpreg(gici10~fpc1602.pres,
    vcv=T,dat=avalon[avalon$groundwater=="Above median flow",])
avfit10.fpc1602.gw.0 = mpreg(gici10~fpc1602.pres,
    vcv=T,dat=avalon[avalon$groundwater=="Below median flow",])

dofit10.fmc1602.berm.1 = mpreg(gici10~fmc1602.pres,
    vcv=T,dat=doheny[doheny$berm=="Open",])
dofit10.fmc1602.berm.0 = mpreg(gici10~fmc1602.pres,
    vcv=T,dat=doheny[doheny$berm=="Closed",])

dofit10.fpc1601.berm.1 = mpreg(gici10~fpc1601.pres,
    vcv=T,dat=doheny[doheny$berm=="Open",])
dofit10.fpc1601.berm.0 = mpreg(gici10~fpc1601.pres,
    vcv=T,dat=doheny[doheny$berm=="Closed",])

dofit10.fpc1602.berm.1 = mpreg(gici10~fpc1602.pres,
    vcv=T,dat=doheny[doheny$berm=="Open",])
dofit10.fpc1602.berm.0 = mpreg(gici10~fpc1602.pres,
    vcv=T,dat=doheny[doheny$berm=="Closed",])

mafit10.fpc1601.berm.1 = mpreg(gici10~fpc1601.pres,
    vcv=T,dat=malibu[malibu$berm=="Open",])
mafit10.fpc1601.berm.0 = mpreg(gici10~fpc1601.pres,
...
save(
  ...
  file="~/dropbox/coliphage/results/rawoutput/regress-10day-body-beach-unadj.Rdata"
)
